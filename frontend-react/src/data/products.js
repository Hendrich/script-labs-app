export const products = [
  {
    id: "selenium-login-pack",
    name: "Selenium Login Test Pack",
  ...
  {
    id: "cypress-checkout-suite",
    name: "Cypress Checkout Suite",
  ...
  {
    id: "playwright-api-ui-bundle",
    name: "Playwright API + UI Bundle",
  ...
  {
    id: "qa-testcase-template",
    name: "QA Test Case Template",
  ...
  {
    id: "regression-smoke-pack",
    name: "Regression & Smoke Pack",
